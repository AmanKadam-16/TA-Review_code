      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          actions: [
            ...
            HelpTooltipButton(
              tooltipMessage: 'Manage locations, addresses, and geofencing settings. Add, edit, or search locations using the controls above.',
            ),            const SizedBox(width: 8),
          ],
        ),
      ),
          ...
          Expanded(
            child: Obx(() {
              ...
              final List<Map<String, String>> tableData =
                ...
                return {
                  'Location Name': location.locationName?.isEmpty == true ? 'N/A' : location.locationName ?? 'N/A',
                  'Address': location.locationAddress?.isEmpty == true ? 'N/A' : location.locationAddress ?? 'N/A',
                  'City': location.locationCity?.isEmpty == true ? 'N/A' : location.locationCity ?? 'N/A',
                  'State': location.locationState?.isEmpty == true ? 'N/A' : location.locationState ?? 'N/A',
                  'GeoFence': location.isUseForGeoFencing == true ? 'Yes' : 'No',
      ...
      builder: (BuildContext context) {
        return Dialog(
          child: LocationDialog(
            location: location, controller: Get.find<LocationController>(),
          ),
        );
      },
    );
